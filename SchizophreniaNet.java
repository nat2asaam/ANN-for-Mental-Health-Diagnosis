...
class SchizophreniaNet extends NeuralNet{
	public void initNet(){
		/* Input layer */
		...
		Neuron inputNeuron9=new Neuron();
		ArrayList<Double> inputWeight9=new ArrayList<Double>();
		inputWeight9.add(new Double(Math.random()));
		inputNeuron9.setListOfWeightIn(inputWeight9);
		listOfInputNeurons.add(inputNeuron9);
		inputLayer.setListOfNeurons(listOfInputNeurons);
		
		Neuron inputNeuron10=new Neuron();
		ArrayList<Double> inputWeight10=new ArrayList<Double>();
		inputWeight10.add(new Double(Math.random()));
		inputNeuron10.setListOfWeightIn(inputWeight10);
		listOfInputNeurons.add(inputNeuron10);
		inputLayer.setListOfNeurons(listOfInputNeurons);
